...
const SignIn = () => {
  ...
  const handleSubmit = () => {
   const val: any = {email: state, token: password}
  ...
  return (
    <div className=" w-full h-[94vh] flex flex-col justify-center items-center ">
      <div className="mb-10 text-center flex items-center w-full flex-col">
        <div className="mb-5 w-20 h-20 rounded-full border flex justify-center items-center font-bold text-[20px]">
          Read
        </div>
      ...
      >
        ...
        <Input
          ...
          errorText={password && "Hope this is the right user token code?"}
          required
          value={password}
          onChange={(e: any) => {
        ...
        <div>
          <Button
            name="Login"
            className="w-[97%] bg-[#C14A4C] text-white h-14 hover:bg-blue-600 transition-all duration-300"
            type="submit"
